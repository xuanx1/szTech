...
| `prd-neighbors/` | High-res HK, Macau, Guangzhou, Dongguan, Huizhou, Zhongshan, Zhuhai geojson — downloaded from Aliyun DataV (`_full.json` where available). Loaded locally for the surrounding-context layer. |
